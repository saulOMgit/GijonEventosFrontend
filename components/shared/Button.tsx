...
const Button: React.FC<ButtonProps> = ({ 
    ...
    const baseClasses = 'inline-flex items-center justify-center border font-semibold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed';
    ...
    const variantClasses = {
        ...
        'danger-outline': 'border-red-300 bg-white text-red-700 hover:bg-red-50 focus:ring-red-500',
    };
